(function (exports, $) {
  ...
  var setShowIssue = function (issueList) {
    issueList.each(function (idx, issueElement) {
      var issue = $(issueElement);
      var target = issue.find('.message p');
      if (target.length !== 1) {
        target = issue.find('.message blockquote');
      }
      var url = $(issue.find('.title a').get(1)).attr('href');
  ...
  var updateShowIssue = function (onUpdated) {
    setTimeout(function () {
  ...
  setShowIssue(currentIssueOpened);
  setShowIssue(currentIssueComment);
  ...
  exports.gdbd.issue = {};
  exports.gdbd.issue.update = updateShowIssue;
